...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/metro/css/theme.css?v=5.1.3&nocache=2559378ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=postsdb&table=posts">`postsdb`.`posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=todo&table=todo">`todo`.`todo`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=NoteKeeper&table=notes">`NoteKeeper`.`notes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=NoteKeeper&table=users">`NoteKeeper`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=StudentsManager&table=Students">`StudentsManager`.`Students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=todo&table=todos">`todo`.`todos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=users">`test`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=BookStore&table=Book">`BookStore`.`Book`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=MyDB&table=Students">`MyDB`.`Students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_livres&table=livre">`gestion_livres`.`livre`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2a6c223e426133385340797e2a6a4856">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="NoteKeeper" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="NoteKeeper" targettable="notes">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `notes`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="NoteKeeper" targettable="notes">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `notes`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="todo" targettable="todo">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            targetdb="postsdb" targettable="posts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `postsdb`.`posts` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `title` VARCHAR(255) NOT NULL ,  `email` VARCHAR(255) NOT NULL ,  `tags` VARCHAR(255) NOT NULL ,  `post` TEXT NOT NULL ,  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
